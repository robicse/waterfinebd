...
@section('title', 'Product Duplicate')
@push('css')
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            {!! Form::model($product, [
                                'route' => Request::segment(1) . '.products.store',
                                'method' => 'POST',
                                'files' => true,
                            ]) !!}
                            <div class="row">
                                    ...
                                    <table class="table" id="review_field">
                                        @foreach ($product->productprice as $key => $info)
                                            <tr id="reviewrow{{ $loop->index }}">
                                                ...
                                                <td style="width:60%">
                                                    <input type="number" id="sub_unit_quentity" name="unit_quantity[]" step="any"
        ...
        $(document).ready(function() {
            ...
            $('#reviewadd').click(function() {
                ...
                $('#review_field').append('<tr id="reviewrow' + r +
                    ...
                    '</select><td style="width:40%"><input type="number" step="any" name="unit_quantity[]" required  placeholder="Quantity" class="form-control" min="0" max="99999999" /></td> </td><td><button type="button" id="' +
                    r +
