                            ...
                            <div class="row">
                                        ...
                                        <table class="table table-responsive">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 15%">Refund Price</th>
                                                    <th style="width: 10%;display:none">Vat(%)</th>
                                                    <th style="width: 10%;display:none">Vat Amount</th>
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tr id="discount_percent_div" style="display:none">
                                ...
                                bottom: 0; z-index: 999;">
                                    <tr>
                                        ...
                                        <td id="PaidAmount" style="display:none">
                                            {!! Form::number('paid', null, ['id' => 'paid', 'class' => 'form-control', 'step' => 'any']) !!}
                                        </td>
                                        <th style="display:none">Due:</th>
                                        <td style="display:none">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#sale_id').on('change', function(){
                ...
                $.ajax({
                    url: "{{ URL(Request::segment(1) . '/sale-info') }}",
                    method: "get",
                    data: {
                        sale_id: sale_id
                    },
                    success: function(res) {
                        console.log('res', res)
                        $("#store_id").html(res.data.storeOptions);
                        $("#customer_id").html(res.data.customerOptions);
                    },
                    error: function(err) {
                        console.log(err)
                    }
            ...
            $(document).on('click', '.addProduct', function(event) {
                ...
                var tr =
                    ...
                    '<td style="display:none" width="12%"><input type="number" class="form-control input-sm text-right" placeholder="0.00" data-format="0[.]00" name="product_vat[]" id="product_vat_id_' +
                    n + '"  data-cell="V' + n + '" required readonly></td>' +

                    '<td style="display:none"><input type="number" class="form-control input-sm text-right" placeholder="0.00" name="product_vat_amount[]" id="product_vat_amount_id_' +
        ...
        function getval(row, sel) {
            ...
            $.ajax({
                url: "{{ URL(Request::segment(1) . '/sale-return-relation-data') }}",
                method: "get",
                data: {
                ...
                success: function(res) {
                    ...
                    if(res.data !== ""){
                        ...
                        $('#show_stock_qty_' + current_row).html(res.data.sale_qty);
                    }else{
                        $('#product_id_' + current_row).val('');
                        alert('No product found of this product, Please selected another product!');
                        return false;
                    }
