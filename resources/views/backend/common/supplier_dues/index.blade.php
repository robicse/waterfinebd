...
@section('title', 'Supplier Due Lists')
@push('css')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.data-table').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.supplier-dues.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
