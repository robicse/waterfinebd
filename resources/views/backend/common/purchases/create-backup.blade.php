                                    ...
                                    <table class="table table-responsive" id="table1">
                                        ...
                                        <tbody id="itemlist">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    form-control"
                                                        placeholder="0.00" name="buy_price[]" onkeyup="buyPriceSum(1,this)"
                                                        id='buy_price_id_1' required data-format="0[.]00"
                                                        data-cell="C1" step="any" min="0"
                                                        max="99999999999999">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control input-sm text-right sell_price" onkeyup="sellPriceSum(1,this)"
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td>
                                                    Due Amount: <span class="required">*</span>
                                                    <input type="text" class="form-control input-sm text-right"
...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.addProduct', function() {
                ...
                var tr =
                    ...
                    '<td width="12%"><input type="number" class="input-sm text-right form-control buy_price" onkeyup="buyPriceSum(' + n +
                    ',this)"  data-format="0[.]00" name="buy_price[]" id="buy_price_id_' +
                    n + '" data-cell=""   value="" required  step="any" min="0" max="99999999999999"></td>' +
                    '<td style="widht:12px"><input class="form-control input-sm text-right sell_price" placeholder="0.00" name="sell_price[]" onkeyup="sellPriceSum(' + n +
                    ',this)"  data-cell="" data-format="0[.]00" data-formula=""></td>' +
        ...
        function discountAmount(){
            ...
            $('#due_amount').val(total - $('#paid_amount').val());
        }
