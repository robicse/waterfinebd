    ...
    <script>
        $(document).ready(function() {
            ...
            $('.data-table').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.customer-dues.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
